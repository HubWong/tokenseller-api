...
from app.core.deps import get_db,DepUser, get_apikey_crud
...
@router.post("/create")
async def create_key_api(api_key: dict, user: DepUser, crud:CRUDApiKey= Depends(get_apikey_crud), db: AsyncSession = Depends(get_db)):
    role = user.role
